...
{
  va_list args;
  gchar * raw_source, * index_line, * source;
  GError * err = NULL;
  ...
  index_line = g_strdup_printf ("%u /testcase.js", (guint) strlen (raw_source));
...
static const gchar *
test_script_fixture_escape_path (TestFixture * fixture,
                                 const gchar * path)
{
#ifdef G_OS_WIN32
  gchar * result;
